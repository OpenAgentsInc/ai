  ...
  inputFields: [
    {
      ...
      type: "string",
      required: true,
      description: "The bounded flattened request.",
    },
    {
      ...
      required: true,
      description:
        "The host-owned admitted delegate-candidate vocabulary; only these may be named.",
    },
  ],
  outputFields: [
    {
    ...
    },
    {
      ...
      required: false,
      description:
        "The preserved bounded task summary handed to the agent when delegating; null otherwise.",
    },
    {
      name: "claimedActions",
      type: "enum",
