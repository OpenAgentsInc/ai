 ...
 */
export const ROUTE_RECOMMENDATION_SCHEMA_LITERAL =
  "openagents.agent_route_recommendation.v1" as const;
export const ROUTE_DECISION_SCHEMA_LITERAL = "openagents.agent_route_decision.v1" as const;
export const OWNER_BOUND_CANDIDATE_SET_SCHEMA_LITERAL =
  "openagents.agent_owner_bound_candidate_set.v1" as const;
...
export const OwnerBoundCandidateSet = S.Struct({
  ...
  ordered: S.Array(TurnProviderRef).check(
    S.isMinLength(1),
