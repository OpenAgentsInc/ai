...
import {
  ...
  type ThreadExportArtifact as ThreadExportArtifactType,
} from "./thread-export-artifact.js";
...
const validateAuthority = (event: ExportedEvent): void => {
  ...
  if (authority.state === "superseded" && authority.supersededByEventRef === event.eventRef) {
