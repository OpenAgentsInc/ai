...
export const TurnCandidateKind = S.Literals(["answer", "completion", "next_edit", "proposal"]);
...
export const InferenceProviderDescriptor = S.Struct({
  ...
  maxContextChars: S.Number.check(
    S.isInt(),
  ...
  maxOutputChars: S.Number.check(
    S.isInt(),
    S.isGreaterThanOrEqualTo(0),
    S.isLessThanOrEqualTo(MAX_TURN_OUTPUT_CHARS),
  ),
